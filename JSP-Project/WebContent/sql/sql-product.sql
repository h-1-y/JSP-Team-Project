...
insert into product(p_id,p_name,p_unitPrice,p_description,p_category,p_unitsInStock,p_fileName) values('A1000','Membrana Hoody',790,'20SS Stone MEMBRANA Hoody Navy','Outer','100','A1000.jpg');
...
delete from category where seq = 3;
drop table category;
